...
HD_PWD='C:/Users/wdj/source/vivado_work/helloworld/helloworld.runs/helloworldip_auto_us_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log helloworldip_auto_us_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source helloworldip_auto_us_0.tcl
