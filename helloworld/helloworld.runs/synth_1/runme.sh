...
HD_PWD='C:/Users/wdj/source/vivado_work/helloworld/helloworld.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log helloworldip_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source helloworldip_wrapper.tcl
