...
HD_PWD='C:/Users/wdj/source/vivado_work/helloworld/helloworld.runs/helloworldip_rst_mig_7series_0_81M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log helloworldip_rst_mig_7series_0_81M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source helloworldip_rst_mig_7series_0_81M_1.tcl
