...
HD_PWD='C:/Users/wdj/source/vivado_work/helloworld/helloworld.runs/helloworldip_mig_7series_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log helloworldip_mig_7series_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source helloworldip_mig_7series_0_0.tcl
