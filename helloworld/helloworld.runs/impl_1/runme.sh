...
HD_PWD='C:/Users/wdj/source/vivado_work/helloworld/helloworld.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log helloworldip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source helloworldip_wrapper.tcl -notrace
