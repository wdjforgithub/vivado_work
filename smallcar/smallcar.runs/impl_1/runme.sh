...
HD_PWD='C:/Users/wdj/source/vivado_work/smallcar/smallcar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log miniCarTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miniCarTop.tcl -notrace
