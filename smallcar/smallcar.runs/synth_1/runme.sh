...
HD_PWD='C:/Users/wdj/source/vivado_work/smallcar/smallcar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miniCarTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miniCarTop.tcl
